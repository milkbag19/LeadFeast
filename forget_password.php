...
$error_log = include("includes/reset_password.inc.php");
?>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    ...
                                    <p class="px-2">Please enter your email to reset your password.</p>
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form method="post">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" id="user-name" name="reset_email" placeholder="Email" required="">

                                                    <label for="user-name">Email</label>
                                                </fieldset>
                                                <div class="form-group d-flex justify-content-between align-items-center">
                                                    <div class="text-right"><a href="register.php" class="card-link">Don't Have an Account?</a></div>
                                                </div>
                                                <input name="submit" type="submit" class="btn btn-primary float-right btn-inline"value="Send Email">
                                            </form>
                                        </div>
                                    </div>
