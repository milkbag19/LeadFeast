...
$error_log = include("includes/reset.inc.php");
?>
                            ...
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    <p style="color:lawngreen;margin:1vh;"><?php
                                        ...
                                        if (isset($error_log['confirm_pwd'])){
                                            echo $error_log['confirm_pwd']."<br>";
                                        }
                                        if (isset($error_log['token'])){
                                            echo $error_log['token']."<br>";
                                        }
                                        if (isset($error_log['reset_email'])){
                                            echo $error_log['reset_email']."<br>";
                                        }
                                    ...
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form method="post">
                                                ...
                                                <fieldset class="form-label-group position-relative has-icon-left">
                                                    <input type="password" class="form-control" id="user-password" name="confirm_pwd" placeholder="Confirm Password" required="">

                                                    <label for="user-password">Confirm Password</label>
                                                </fieldset>

                                                <fieldset class="form-label-group position-relative has-icon-left">
                                                    <input type="password" class="form-control" id="user-password" name="token" placeholder="Token" required="">

                                                    <label for="user-password">Token</label>
                                                </fieldset>
                                                ...
                                                <input name="submit" type="submit" class="btn btn-primary float-right btn-inline"value="Reset">
                                            </form>
                                        </div>
                                    </div>
