...
if(isset($_POST['list'])){
    echo"<script>window.location.href='./full_follower_list.php?select_user=".$_GET['select_user']."';</script>";
}
?>
            ...
            <div class="col-12">
             <div class="card">
                    <div class="card-body">
                        ...
                        <h4 style="font-weight: bold;"><?php if($_SESSION['pay_level']!=='0'){echo'Only loads new followers from today!</h4>
                        <form method="post">
                            ...
                            <button  style="padding:  8px 8px; border:  0px; border-radius:  3px;width:150px; font-size: 0.75rem;font-stretch: expanded;" name="list" class="btn btn-warning waves-effect waves-light">All Followers</button>
                        </form> ';} ?>
                        <br><br>
                        <?php
                        if($_SESSION['pay_level'] !== '0') {
                            if (!isset($_GET['select_user'])) {
                                ...
                                getFollowers($_GET['select_user'], $_SESSION['pay_level'], $_SESSION['id'], $user_data['access_token'], $user_data['access_secret'], $user_data['consumer_key'], $user_data['consumer_secret'], $conn);
